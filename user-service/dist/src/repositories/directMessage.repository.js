...
export class DirectMessageRepository {
     ...
     */
    static async create(senderId, receiverId, content, attachments) {
    ...
    static async getUserConversations(userId) {
        ...
        const conversations = await Promise.all(conversationPartnerIds.map(async (partnerId) => {
        ...
        return conversations.filter(c => c.lastMessage).sort((a, b) => b.lastMessage.createdAt.getTime() - a.lastMessage.createdAt.getTime());
    }
    /**
     ...
     */
    static async getUnreadCount(receiverId, senderId) {
...
//# sourceMappingURL=directMessage.repository.js.map